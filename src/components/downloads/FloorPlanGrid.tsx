    ...
    <Document>
      <Page size="LETTER" style={s.page}>
        <View style={s.headerCard}>
          ...
          <Text style={s.title}>Floor Plan Grid</Text>
          <Text style={s.subtitle}>
            {"Use this grid to sketch your floor plan at 1/4\" = 1'-0\" scale."}
          </Text>
        </View>
        ...
        <View style={s.reminderBox}>
          ...
          <Text style={s.reminderText}>
            Walls drawn with thick lines, doors shown with swing arcs, windows
            drawn within wall thickness, furniture and fixtures to scale, room
            labels with dimensions, and dimension strings along the perimeter.
          </Text>
        </View>
        ...
        <View style={s.footer}>
          <Text style={s.footerText}>
            FOUNDATIONS OF ARCHITECTURE - FLOOR PLAN GRID
          </Text>
