...
The course covers 107 lessons across 11 modules: Welcome & Orientation, Kickoff (Dream Home Discovery), Architecture as an Idea, Definitions of Architecture, Drawing Foundations, Materiality & Systems, Environmental Design, Portfolio Project, Bonus Lessons, AI for Architecture, and Resources & Completion.
...
Course overview:
- 107 lessons across 11 modules covering architecture fundamentals for homeowners
...
- Course Only: $47 (normally $93) — full access to all 107 lessons, downloadable resources, and certificate
