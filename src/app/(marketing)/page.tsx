...
export const metadata: Metadata = {
  ...
  description:
    "A self-paced online architecture course for homeowners. Learn residential design fundamentals — floor plans, elevations, materials, and more. 107 lessons, two learning paths, 31 downloadable resources. No degree required.",
  alternates: {
    canonical: siteUrl,
  },
};
...
const productSchema = {
  ...
  description:
    "A beginner-friendly online course teaching residential architecture fundamentals. 107 lessons, two learning paths, and 31 downloadable resources.",
  brand: {
    "@type": "Brand",
    name: "Foundations of Architecture",
  },
